...
zooAnimals.map(n => {
  let lowerName = n.animal_name.toLowerCase();
...
*/
const largerPopulation = zooAnimals.filter(p => {
  return p.population < 5;
});
...
*/
const populationTotal = zooAnimals.reduce((accumulator, zoo) => {
